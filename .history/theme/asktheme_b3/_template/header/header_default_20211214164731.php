						...
						<li class="basic-nav-parent" style="padding:0;">
							...
							<?php
								...
								for ($k = 0; $row2 = sql_fetch_array($result2); $k++) {
									...
									$submenu .= "<li style='display:inline-block;width: 100%; padding:0; word-wrap: break-word;' class='sub-list'><a href='" . ask_short_url_clean($row2['me_link']) . "' target='_{$row2['me_target']}'>{$row2['me_name']}</a></li>";
								}
