			...
			<nav id="basic-primary-menu" class="basic-home-menu" aria-labelledby="basic-main-menu">
				<ul class="basic-main-menu basic-home-nav">
					...
					for ($i = 0; $row = sql_fetch_array($result); $i++) {
						?>
						<li class="basic-nav-parent" style="box-sizing:content-box; ">
							...
							<?php
								...
								for ($k = 0; $row2 = sql_fetch_array($result2); $k++) {
									...
									$submenu .= "<li class='sub-list' style='width:180px; '><a href='" . ask_short_url_clean($row2['me_link']) . "' target='_{$row2['me_target']}'>{$row2['me_name']}</a></li>";
								}
