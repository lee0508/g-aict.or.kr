	...
	<div id="basic-header-wrap" class="basic-primary-header">
		...
		<div class="container pc-main-menu">
			...
			<nav id="basic-primary-menu" class="basic-home-menu" aria-labelledby="basic-main-menu" styel="overflow:hidden;">
				<ul class="basic-main-menu basic-home-nav" stye:="display:block;padding:0;">
					<?php
					//모바일일 경우 모바일 메뉴만 출력
					if (is_mobile() == true) {
					...
					for ($i = 0; $row = sql_fetch_array($result); $i++) {
						?>
						<li class="basic-nav-parent" style="width: 142px;padding:0;">
							...
							<?php
								...
								for ($k = 0; $row2 = sql_fetch_array($result2); $k++) {
									if ($k == 0) {
										$submenu .= '<ul style="width: 100%;" class="sub-menu navi-child" id="sub-id-' . $k . '">' . PHP_EOL;
									}
