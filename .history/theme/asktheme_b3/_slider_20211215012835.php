...
nav#main_nav > ul.main_ul > li.main_li > ul.sub-menu { height:0;overflow:hidden; }
nav#main_nav > ul.main_ul > li.main_li > a:hover ul.sub-menu > li {height:500px;z-index:99; }
</style>
