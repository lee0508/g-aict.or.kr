...
nav#main_nav > ul.main_ul { list-style-type: none; margin:0;padding:0; float:left;}
nav#main_nav > ul.main_ul > li.main_li {height:30px;vertical-align: middle;list-style-type: none;}
...
nav#main_nav > ul.main_ul > li.main_li > ul.sub-menu.navi-child { height:0; overflow:hidden; }
nav#main_nav > ul.main_ul > li.main_li > a:hover > ul.sub-menu.navi-child > li.sublist > a { height:500px;z-index:9999; overflow:visible; }
</style>
