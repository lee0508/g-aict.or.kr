...
nav#main_nav {border:1px solid transparent;height:60px;padding:0;margin:0;list-style: none;text-decoration: none;clear: both; position: relative;}
nav#main_nav > ul.main_ul { list-style-type: none; margin:0;padding:0; }
nav#main_nav > ul.main_ul > li.main_li {float:left;line-height:60px;vertical-align: middle;text-align: center; position: relative;margin-right:15px;}
