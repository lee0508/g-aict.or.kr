...
nav#main_nav > ul.main_ul > li.main_li > ul#sub-id-0.sub-menu.navi-child > li > a { border-bottom: 1px solid #cdcdcd;display:block; width:220px; height:30px; line-height: 30px;}
