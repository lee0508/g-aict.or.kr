...
nav#main_nav > ul.main_ul > li.main_li {float:left;width:180px;height:30px;vertical-align: middle;list-style-type: none;text-align: center;margin-right: 30px; }
/* nav#main_nav > ul.main_ul > li.main_li:last-child {margin-right:0;} */
nav#main_nav > ul.main_ul > li.main_li > a {background:#c9c9c9;color:#191919;display: inline-block; width:180px;font-size:14px;line-height:30px;}
nav#main_nav > ul.main_ul > li.main_li > a > ul#sub-id-0.sub-menu.navi-child >  li.sublist { height:0; overflow:hidden; }
nav#main_nav > ul.main_ul > li.main_li > a:hover > ul#sub-id-0.sub-menu.navi-child > li.sublist > a { display:block;width: 200px;height:30px;z-index:9999; overflow:visible; }
</style>
