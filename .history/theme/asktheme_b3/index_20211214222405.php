        ...
        <div class="col-sm-12 col-md-4 delay-_3 info-block">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">모바일, PC용 솔루션, POS, 기타</p>
        ...
        <div class="col-sm-12 col-md-4 delay-_6 info-block">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <a href="<?php echo ask_get_pretty_board_url('promotion');?>" class="btn btn-light btn-sm">More</a>
                </div>
            </div>
        </div>
    </section>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <ul class="customer-info">
                                <li class='cus-tel'>TEL : 02-1234-5678</li>
                                <li class='cus-fax'>FAX : 02-1234-5679</li>
                                <li class='cus-email'>Email : customer@site.kr</li>
                            </ul>
                        </div>
                    </div>
                </div>
                <div class="col-6 col-sm-6 col-md-6 col-lg-3">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="<?php echo ask_get_pretty_board_url('notice'); ?>" class="sl-subject">공지사항</a>
                        </div>
                        <div class="card-body">
                            <?php
                ...
                <div class="col-6 col-sm-6 col-md-6 col-lg-3">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="<?php echo ask_get_pretty_board_url('recruit');?>" class="sl-subject">채용정보</a>
                        </div>
                        <div class="card-body">
                            <?php
                                /*
