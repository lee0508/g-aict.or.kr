...
nav#main_nav > ul.main_ul > li.main_li > ul#sub-id-0.sub-menu.navi-child { display:none;position:absolute;list-style-type: none;z-index:9999; text-align: left;margin:0;padding:0;transition: height .5s; -webkit-transition: height .5s; -moz-transition: height .5s; -o-transition: height .5s; }
