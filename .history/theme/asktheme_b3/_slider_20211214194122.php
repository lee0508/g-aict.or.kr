...
nav#main_nav > ul.main_ul > li > a {border:1px solid;background:#c9c9c9;color:#fff;display: inline-block; width:100%;height:80px;line-height:60px; text-align:center;}
