        ...
        -->
            ...
            <div class="swiper-slide" data-swiper-autoplay="10000" id='bgPlayer1'>
                ...
                <?php
                    ...
                    */
                ?>
                <div id="bgPlayer" class="player" data-property="{videoURL:'https://www.youtube.com/watch?v=V_ZPiSHSklc',vol:'90',stopMovieOnBlur:false,containment:'#bgPlayer1',showControls:false,startAt:0,mute:true,autoPlay:true,loop:true,opacity:1,quality:'highres',optimizeDisplay:false}"></div>
