...
nav#main_nav {border:1px solid transparent;width:100%;height:40px;background:#2d2d2d;padding:0;margin:0;list-style-type: none;text-decoration: none;}
nav#main_nav > ul.main_ul { list-style-type: none; margin:0;padding:0; }
nav#main_nav > ul.main_ul > li.main_li {display:inline-block;width:180px;height:30px;vertical-align: middle;list-style-type: none;text-align: center;margin-right: 30px; position:relative; }
/* nav#main_nav > ul.main_ul > li.main_li:last-child {margin-right:0;} */
nav#main_nav > ul.main_ul > li.main_li > a {color:#fff;display: block; font-size:14px;line-height:20px;}
nav#main_nav > ul.main_ul > li.main_li > ul#sub-id-0.sub-menu.navi-child { position:absolute;height:0;overflow:hidden;list-style-type: none;z-index:9999; text-align: left;margin:0;padding:0;transition: height .5s; -webkit-transition: height .5s; -moz-transition: height .5s; -o-transition: height .5s; }
nav#main_nav > ul.main_ul > li.main_li > ul#sub-id-0.sub-menu.navi-child > li > a { border-bottom: 1px solid #cdcdcd;display:block; width:220px; height:30px; line-height: 30px; padding-left: 8px;}
nav#main_nav > ul.main_ul > li.main_li > ul#sub-id-0.sub-menu.navi-child > li > a:hover { background:#000; color:#fff; }
nav#main_nav > ul.main_ul > li.main_li:hover > ul#sub-id-0.sub-menu.navi-child { border:1px solid #ccc;display:block; height:500px;transition: 0.3s;}
</style>
            ...
            <div class="swiper-slide" data-swiper-autoplay="10000" id='bgPlayer1'>
                <div class="container">
                    <div class='slider-catpion youtube'>
                        ...
                        <a href="https://www.youtube.com/watch?v=V_ZPiSHSklc" class="slide-more-btn ani-text-subtext delay-2">More Information</a>
                    </div>
                </div>
                ...
                <?php
                    ...
                    */
                ?>
                <div id="bgPlayer" class="player" data-property="{videoURL:'https://www.youtube.com/watch?v=V_ZPiSHSklc',vol:'90',stopMovieOnBlur:false,containment:'#bgPlayer1',showControls:false,startAt:0,mute:true,autoPlay:true,loop:true,opacity:1,quality:'highres',realfullscreen:true,optimizeDisplay:false}"></div>
            ...
            <li class="main_li">
                ...
                <?php
                    ...
                    for ($k = 0; $row2 = sql_fetch_array($result2); $k++) {
                        ...
                        $submenu .= "<li class='sub-list'><a href='" . ask_short_url_clean($row2['me_link']) . "' target='_{$row2['me_target']}'>{$row2['me_name']}</a></li>";
                    }
