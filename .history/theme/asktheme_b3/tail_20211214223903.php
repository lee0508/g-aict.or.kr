        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-md-9 col-lg-7 tail-menu-wrap">
                ...
                <div class="tail-contents">
                    ...
                    <ul class='breadcrumb'>
                        <li class='breadcrumb-item'><span>(사)글로벌 인공지능협회</span> </li>
                        <!-- <li class='breadcrumb-item'><span>사업자등록번호</span> : 000-00-00000 </li> -->
                        <!-- <li class='breadcrumb-item'><span>통신판매업신고</span> : 제100-서울00-0000호</li> -->
                    </ul>
                    <ul class='breadcrumb'>
                        <li class='breadcrumb-item'><span>주소</span> : 서울특별시 영등포구 국회대로72길 5, 6층 602호</li>
                        <li class='breadcrumb-item'><span>대표전화</span> : 02-890-6890 </li>
