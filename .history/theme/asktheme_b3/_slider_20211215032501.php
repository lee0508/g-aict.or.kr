...
nav#main_nav > ul.main_ul > li.main_li {display:inline-block;width:160px;height:30px;vertical-align: middle;list-style-type: none;text-align: center;margin-right: 30px; position:relative; }
/* nav#main_nav > ul.main_ul > li.main_li:last-child {margin-right:0;} */
nav#main_nav > ul.main_ul > li.main_li > a {color:#fff;display: block; width:160px;font-size:14px;line-height:20px;}
