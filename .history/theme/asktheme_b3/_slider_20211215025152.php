...
nav#main_nav > ul.main_ul > li.main_li > ul#sub-id-0.sub-menu.navi-child { display:none;position:absolute;list-style-type: none;z-index:9999; text-align: left;margin:10px 0 0 0;padding:0; }
nav#main_nav > ul.main_ul > li.main_li > ul#sub-id-0.sub-menu.navi-child > li > a { border-bottom: 1px solid #cdcdcd;display:block; width:220px; height:30px; }
