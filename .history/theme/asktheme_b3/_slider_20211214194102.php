...
nav#main_nav {border:1px solid;height:80px;padding:0;margin:0;list-style: none;text-decoration: none;clear: both; overflow:hidden;position: relative;}
nav#main_nav > ul.main_ul { width: 50em;margin:0;position: relative; }
nav#main_nav > ul.main_ul > li {float:left;margin:0;padding:0;list-style: none;width:120px; }
nav#main_nav > ul.main_ul > li > a {border:1px solid;background:#c9c9c9;color:#fff;display: inline-block; width:100%;height:80px;font-weight: bold;font-size: 18px;line-height:60px; text-align:center;}
nav#main_nav > ul.main_ul > li > ul.sub-menu {display:none}
</style>
