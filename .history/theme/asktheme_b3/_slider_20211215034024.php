...
nav#main_nav > ul.main_ul > li.main_li {display:inline-block;vertical-align: middle;list-style-type: none;text-align: center;margin-right: 0px; position:relative; }
nav#main_nav > ul.main_ul > li.main_li:last-child { display:none; }
/* nav#main_nav > ul.main_ul > li.main_li:last-child {margin-right:0;} */
nav#main_nav > ul.main_ul > li.main_li > a {color:#fff;display: block;height:40px;font-size:14px;line-height:20px;}
nav#main_nav > ul.main_ul > li.main_li > ul#sub-id-0.sub-menu.navi-child { display:none;position:absolute;list-style-type: none;z-index:9999; text-align: left;margin:0;padding:0; }
nav#main_nav > ul.main_ul > li.main_li > ul#sub-id-0.sub-menu.navi-child > li > a { border-bottom: 1px solid #cdcdcd;display:block; width:220px; height:30px; line-height: 30px; padding-left: 8px;font-size:14px;}
...
<nav id="main_nav">
    <ul class="main_ul">
        ...
        for ($i = 0; $row = sql_fetch_array($result); $i++) {
            ...
            <li class="main_li" style="color:#fff;">|</li>
        <?php
        }
