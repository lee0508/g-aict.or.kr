...
nav#main_nav {border:1px solid;width:100%;height:80px;padding:0;margin:0;list-style: none;text-decoration: none;clear: both; overflow:hidden;position: relative;}
nav#main_nav > ul.main_ul { width: 1200px;height:60px;margin:0;position: relative; }
nav#main_nav > ul.main_ul > li {float:left;margin:0;padding:0;list-style: none;width:120px; height: 60px; }
nav#main_nav > ul.main_ul > li > a {border:1px solid;display: inline-block; text-align: center;height:60px;line-height:60px;}
