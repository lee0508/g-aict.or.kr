...
nav#main_nav > ul.main_ul > li {float:left;margin:0;padding:0;list-style: none;text-align:center; }
nav#main_nav > ul.main_ul > li > a {border:1px solid;background:#c9c9c9;color:#fff;display: block; width:180px;font-size:14px;line-height:60px;}
