...
nav#main_nav > ul.main_ul { margin:0;position: relative; display:flex;}
nav#main_nav > ul.main_ul > li {flex:1;margin:0;padding:0;list-style: none;text-align:center; height:60px; }
