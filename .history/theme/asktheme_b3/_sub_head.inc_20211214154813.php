...
?>
<style type="text/css">
    .header.header_default #basic-header-wrap #basic-primary-menu .basic-main-menu .basic-nav-parent {
...
if ($submenu) {
    ...
    foreach ($submenu as $menu) {
        ...
        $menu_str .= "<li  style='margin-right:130px;' {$active}><a href='{$menu['me_link']}'>{$menu['me_name']}</a></li>";
    }
    $menu_str .= '</ul></div>';
}
