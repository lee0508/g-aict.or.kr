...
nav#main_nav > ul.main_ul > li.main_li {display:inline-block;width:180px;vertical-align: middle;list-style-type: none;text-align: center;margin-right: 30px; position:relative; }
/* nav#main_nav > ul.main_ul > li.main_li:last-child {margin-right:0;} */
nav#main_nav > ul.main_ul > li.main_li > a {background:#c9c9c9;color:#191919;display: block; width:180px;height:30px;font-size:14px;line-height:30px;}
