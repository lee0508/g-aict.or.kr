...
nav#main_nav > ul.main_ul > li.main_li > ul#sub-id-0.sub-menu.navi-child { display:none;position:absolute;list-style-type: none; }
nav#main_nav > ul.main_ul > li.main_li:hover > ul#sub-id-0.sub-menu.navi-child > li.sublist { display:block; }
</style>
