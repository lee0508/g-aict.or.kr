...
nav#main_nav > ul.main_ul { width: 1200px;height:80px;margin:0;position: relative; }
nav#main_nav > ul.main_ul > li {float:left;margin:0;padding:0;list-style: none;width:120px; }
nav#main_nav > ul.main_ul > li > a {border:1px solid;display: inline-block; text-align: center;height:80px;line-height:60px;}
