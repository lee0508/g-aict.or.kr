...
nav#main_nav > ul.main_ul > li > a {border:1px solid;background:#c9c9c9;color:#fff;display: inline-block; text-align: center;height:80px;font-weight: bold;font-size: 12px;line-height:60px;}
