...
nav#main_nav {border:1px solid;height:60px;padding:0;margin:0;list-style: none;text-decoration: none;clear: both; overflow:hidden;position: relative;}
nav#main_nav > ul.main_ul { margin:0;position: relative; }
nav#main_nav > ul.main_ul > li {float:left;margin:0;padding:0;list-style: none;text-align:center; height:60px;vertical-align:center; }
nav#main_nav > ul.main_ul > li > a {border:1px solid;background:#c9c9c9;color:#fff;display: block; width:180px;font-size:14px;}
