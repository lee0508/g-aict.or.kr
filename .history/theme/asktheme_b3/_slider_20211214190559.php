...
nav#main_menu {border:1px solid;width:100%;height:60px;margin:0;list-style: none;text-decoration: none;clear: both; overflow:hidden;position: relative;}
nav#main_menu > ul > li {float:left;list-style: none; clear: both; }
</style>
