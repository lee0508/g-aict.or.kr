...
nav#main_nav > ul.main_ul > li {float:left;line-height:60px;vertical-align: middle;text-align: center; position: relative;padding:0 0 30px 0;}
nav#main_nav > ul.main_ul > li > a {border:1px solid transparent;background:#c9c9c9;color:#191919;display: block; width:180px;font-size:14px;line-height:30px;}
