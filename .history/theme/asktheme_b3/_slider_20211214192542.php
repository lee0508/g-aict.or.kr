...
nav#main_nav {border:1px solid;width:100%;padding:0;margin:0;list-style: none;text-decoration: none;clear: both; overflow:hidden;position: relative;}
nav#main_nav > ul.main_ul { width: 600px;height:60px;margin:0;position: relative; }
nav#main_nav > ul.main_ul > li {position:absolute;left:0;top:0;list-style: none; height: 60px; }
