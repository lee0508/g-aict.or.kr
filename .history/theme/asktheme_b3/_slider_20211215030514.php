...
nav#main_nav {border:1px solid transparent;width:100%;height:30px;background:#2d2d2d;padding:0;margin:0;list-style-type: none;text-decoration: none;}
...
nav#main_nav > ul.main_ul > li.main_li > a {background:#c9c9c9;color:#191919;display: block; width:180px;font-size:14px;line-height:20px;}
