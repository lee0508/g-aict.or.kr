...
nav#main_nav > ul.main_ul > li.main_li > ul#sub-id-0.sub-menu.navi-child { height:0; overflow:hidden; }
nav#main_nav > ul.main_ul > li.main_li > a:hover > ul#sub-id-0.sub-menu.navi-child > li.sublist > a { height:500px;z-index:9999; overflow:visible; }
</style>
